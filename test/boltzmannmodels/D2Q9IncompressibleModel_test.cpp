...
BOOST_AUTO_TEST_CASE(D2Q9IncompressibleModelConstruction_test) {
	...
	BOOST_CHECK_EQUAL(dqmodel.speedOfSound, sqrt(1./3.));
	BOOST_CHECK_EQUAL(dqmodel.speedOfSoundSquare, 1./3.);
...
BOOST_AUTO_TEST_CASE(D2Q9IncompressibleModelStatic_test) {
	...
	BOOST_CHECK_EQUAL(D2Q9IncompressibleModel::speedOfSound, sqrt(1./3.));
	BOOST_CHECK_EQUAL(D2Q9IncompressibleModel::speedOfSoundSquare, 1./3.);
