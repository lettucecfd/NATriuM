...
#ifndef ANALYSIS_CAVITY_CONVERGENCE_COMPARETOERTURK_H_
#define ANALYSIS_CAVITY_CONVERGENCE_COMPARETOERTURK_H_
...
class CompareToErturk: public DataProcessor<2> {
private:
	// Reynolds number
	size_t m_Re;
	// y-values
	...
	double m_vError;
public:
	CompareToErturk(const CFDSolver<2>& solver, size_t reynolds, string filename);
	virtual ~CompareToErturk();
...
#endif /* ANALYSIS_CAVITY_CONVERGENCE_COMPARETOERTURK_H_ */
