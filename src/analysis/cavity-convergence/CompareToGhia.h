...
#ifndef ANALYSIS_CAVITY_CONVERGENCE_COMPARETOGHIA_H_
#define ANALYSIS_CAVITY_CONVERGENCE_COMPARETOGHIA_H_
...
class CompareToGhia: public DataProcessor<2> {
private:
	// Reynolds number
	size_t m_Re;
	// y-values
	...
	double m_vError;
public:
	CompareToGhia(const CFDSolver<2>& solver, size_t reynolds, string filename);
	virtual ~CompareToGhia();
...
#endif /* ANALYSIS_CAVITY_CONVERGENCE_COMPARETOGHIA_H_ */
