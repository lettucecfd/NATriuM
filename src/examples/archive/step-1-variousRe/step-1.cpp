...
int main(int argc, char** argv) {
	...
	parse.addDocumentationString("step-1-variousRe-taylorGreenVortex", "This program runs the two-dimensional Taylor-Green vortex on a regular grid.");
...
//			pout << "FE order = " << orderOfFiniteElement << endl;
		...
		dirName << getenv("NATRIUM_HOME") << "/step-1-variousRe-iterative";
