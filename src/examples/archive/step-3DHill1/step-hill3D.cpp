...
int main(int argc, char** argv) {
	...
	boost::shared_ptr<ProblemDescription<3> >  hill_flow = boost::make_shared<
	...
	//! [Solver]
	CFDSolver<3> solver(configuration, hill_flow);
	solver.run();

	pout << "NATriuM lidDrivenCavity2D terminated." << endl;
