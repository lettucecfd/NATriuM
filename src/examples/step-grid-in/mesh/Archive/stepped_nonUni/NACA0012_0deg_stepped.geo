...
//Transfinite Curve {403, 404} = n_inlet Using Progression 1;        // inlet circle points
...
//Transfinite Curve {-411, -412} = n_around Using Progression progression_around;              // outlet end lines points

/// CHANNEL
Line(420)  = {400, 410};                               // channel top line
Line(421)  = {401, 411};                               // channel bottom line
//Transfinite Curve {420} = n_channel Using Progression 1;      // channel top points
//Transfinite Curve {421} = n_channel Using Progression 1;      // channel bottom points


/// OUTLET / CHANNEL SURFACES
Curve Loop(522) = {-401, 420, 411, -410, 0:69}; // channel top
...
//Transfinite Surface{1,2,4,5,6,7};
//Recombine Surface{1,2,4,5,6,7};
...
Save "NACA0012_0deg_stepped.msh";
