...
/// INLET
Point(2200) = {0, inlet_r, 0, size_in_out};       // inlet top
Point(2201) = {0, -inlet_r, 0, size_in_out};      // inlet bottom
Point(2202) = {inlet_c-inlet_front, 0, 0, size_in_out};     // inlet front
...
/// OUTLET
Point(2210) = {outlet_c, outlet_h, 0, size_in_out};   // outlet top
Point(2211) = {outlet_c, -outlet_h, 0, size_in_out};  // outlet bottom
Point(2212) = {outlet_c, 0, 0, size_in_out};          // outlet center
