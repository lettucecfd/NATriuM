...
size_sponge  = 1;
n_coarsen    = 1;
n_points     = 197;  // 197/n_coarsen;
point_id_top = 76;  // 76/n_coarsen;
point_id_bot = 124;  // (n_points+1) - (point_id_top-2);
point_id_front = 100;  // 99/n_coarsen + 1;
n_around     = 100;  // 100/n_coarsen; // 50/n_coarsen for plot
n_foil       = 2;
n_inlet      = point_id_front - point_id_top + 1;  // (n_coarsen+1)/2;  // +1 @1; +2 @3
channel_l    = 1.5;
channel_h    = inlet_r;
n_channel    = 300;  // 400/n_coarsen;  // 300/n_coarsen for plot
n_outlet_center = n_channel - point_id_top + 1;  // (n_coarsen+1)/2;  // +1 @1; +2 @3
progression_around = 1.05;
progression_sponge = 1.05;
n_sponge_front= 57;  // 28*2/n_coarsen+1;
n_sponge_back= 50;  // 25*2/n_coarsen;
