//FILE newNonUniUnstructured 0deg res100
// nc coarsens the shape of the foil
nc = 5;
...
size_foil    = 0.005;
size_in      = 0.05;
size_out     = size_in; //0.15;
size_out_centre = size_foil; //size_in; //0.15;
size_sponge  = 0.5;

// ONLY FOR IMAGE
// fac coarsens the cells themselves
fac          = 2;
size_foil    = fac*size_foil;
size_in      = fac*size_in;
size_out     = fac*size_out;
size_sponge  = fac*size_sponge;
...
Point(2212) = {outlet_c, 0, 0, size_out_centre};          // outlet center
...
Physical Curve(303) = {1:nx-1:nc};  // "BB_BC", 
