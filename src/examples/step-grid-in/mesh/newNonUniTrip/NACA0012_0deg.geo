...
Transfinite Curve {-212} = n_around Using Progression progression_around;              // outlet end lines points
Transfinite Curve {-211} = n_around Using Progression progression_around;              // outlet end lines points

/// CHANNEL
Line(220)  = {200, 210};                               // channel top line
Line(221)  = {201, 211};                               // channel bottom line
Transfinite Curve {220} = n_channel/5 Using Progression 1;      // channel top points
Transfinite Curve {221} = n_channel/5 Using Progression 1;      // channel bottom points
