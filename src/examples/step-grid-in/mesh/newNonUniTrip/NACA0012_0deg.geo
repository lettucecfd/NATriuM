...
n_outlet_center = 400 - point_id_top + 1;
...
Transfinite Curve {-201, -202} = n_around Using Progression progression_around;  // inlet lines points top/bottom
Transfinite Curve {200} = n_around Using Progression progression_around;  // inlet lines points front
...
Transfinite Curve {-212} = n_around Using Progression progression_around;    // outlet end lines points bottom
Transfinite Curve {-211} = n_around Using Progression progression_around;  // outlet end lines points top
