...
4. For dealII: `zlib` (and `gsl` for Cluster)

```
conda install -c conda-forge cxx-compiler libgfortran5 fortran-compiler cmake>=3.23 openmpi libhwloc libevent blas liblapack zlib gslcd .
```
