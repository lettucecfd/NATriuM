\hypertarget{LinearBoundary_8h}{
\section{/mnt/fdrive/akraem3m/workspace/NATriuM/src/library/natrium/problemdescription/LinearBoundary.h File Reference}
\label{LinearBoundary_8h}\index{/mnt/fdrive/akraem3m/workspace/NATriuM/src/library/natrium/problemdescription/LinearBoundary.h@{/mnt/fdrive/akraem3m/workspace/NATriuM/src/library/natrium/problemdescription/LinearBoundary.h}}
}
...
\item 
class \hyperlink{classnatrium_1_1LinearBoundary}{natrium::LinearBoundary$<$ dim $>$}
\begin{DoxyCompactList}\small\item\em Abstract class to describe Linear boundary conditions. The virtual function to be overriden is assembleBoundary. Moreover, the DoF couplings at the boundary have to be defined (see Documentation of the constructors). \item\end{DoxyCompactList}\end{DoxyCompactItemize}
