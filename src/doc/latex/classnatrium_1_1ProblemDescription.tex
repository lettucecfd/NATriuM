...
\index{natrium::ProblemDescription@{natrium::ProblemDescription}!ProblemDescription@{ProblemDescription}}
\index{ProblemDescription@{ProblemDescription}!natrium::ProblemDescription@{natrium::ProblemDescription}}
\subsubsection[{ProblemDescription}]{\setlength{\rightskip}{0pt plus 5cm}template$<$size\_\-t dim$>$ {\bf natrium::ProblemDescription}$<$ dim $>$::{\bf ProblemDescription} (boost::shared\_\-ptr$<$ Mesh$<$ dim $>$ $>$ {\em triangulation}, \/  double {\em viscosity}, \/  double {\em characteristicLength})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
