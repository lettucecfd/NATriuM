...
double {\bfseries natrium::Math::maxVelocityNorm} (const vector$<$ distributed\_\-vector $>$ \&velocity)}
...
double {\bfseries natrium::Math::velocity2Norm} (const vector$<$ distributed\_\-vector $>$ \&velocity)}
