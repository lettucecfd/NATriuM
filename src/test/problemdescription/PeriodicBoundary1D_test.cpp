...
BOOST_AUTO_TEST_CASE(PeriodicBoundary1D_ConstructionByBoundaryIndicator_test) {
	...
	// FAILURE TEST //
	//////////////////
	BOOST_CHECK_THROW(PeriodicBoundary1D(0, 0, triangulation), PeriodicBoundaryNotPossible);
	BOOST_CHECK_THROW(PeriodicBoundary1D(0, 2, triangulation), PeriodicBoundaryNotPossible);
	BOOST_CHECK_THROW(PeriodicBoundary1D(0, 3, triangulation), PeriodicBoundaryNotPossible);
