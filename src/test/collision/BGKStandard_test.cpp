...
BOOST_AUTO_TEST_CASE(BGKStandardConstruction_test) {
	...
	BOOST_CHECK_NO_THROW(BGKStandard bgkCollision(tau, dt, boost::make_shared<D2Q9>()));
...
BOOST_AUTO_TEST_CASE(BGKStandardSetTimeStep_test) {
	...
	double tau = 0.9;
	double dt = 0.1;
	BGKStandard bgkCollision(tau, dt, boost::make_shared<D2Q9>());
...
BOOST_AUTO_TEST_CASE(BGKMoments_test) {
	...
	double tau = 0.9;
	BGKStandard bgk(tau, 0.1, boost::make_shared<D2Q9>());
...
BOOST_AUTO_TEST_CASE(BGKStandard_collideAllD3Q19_test) {
	...
	// create collision model// create collision model
	boost::shared_ptr<Stencil> dqmodel = boost::make_shared<D3Q19>();
	double tau = 0.9;
	BGKStandard bgk(tau, 0.1, boost::make_shared<D3Q19>());
...
BOOST_AUTO_TEST_CASE(BGKStandard_collideAllD3Q15_test) {
	...
	pout << "BGKStandard_collideAllD3Q15_test..." << endl;
