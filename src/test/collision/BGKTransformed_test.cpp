...
BOOST_AUTO_TEST_CASE(BGKTransformedConstruction_test) {
	...
	BOOST_CHECK_NO_THROW(BGKTransformed bgkCollision(9,tau));
...
BOOST_AUTO_TEST_CASE(BGKTransformedGetter_test) {
	...
	double tau = 0.9;
	BGKTransformed bgkCollision(9, tau);
...
BOOST_AUTO_TEST_CASE(BGKTransformedCollisionInvariants_test) {
	...
	Collision<D2Q9IncompressibleModel, BGKTransformed> bgk_collision(dqmodel, bgk);
