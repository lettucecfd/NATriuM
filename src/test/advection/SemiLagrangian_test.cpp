...
BOOST_AUTO_TEST_CASE(SemiLagrangian2D_Neighborhood_test) {
	...
	// cell is corner!
	BOOST_CHECK_EQUAL(n_periodic_x, 3);
	BOOST_CHECK_EQUAL(n_periodic_y, 3);
...
BOOST_AUTO_TEST_CASE(SemiLagrangian3D_Neighborhood_test) {
	...
	BOOST_CHECK_EQUAL(neighbors.size(), 27);
	double dx = pow(0.5, 3);
	size_t n_periodic_x = 0;
	size_t n_periodic_y = 0;
	...
	// cell is corner!
	BOOST_CHECK_EQUAL(n_periodic_x, 9);
	BOOST_CHECK_EQUAL(n_periodic_y, 9);
	BOOST_CHECK_EQUAL(n_periodic_z, 9);
