...
PeriodicTestFlow2D::PeriodicTestFlow2D(double relaxationParameter, const numeric_vector& velocity) :
...
PeriodicTestFlow2D::~PeriodicTestFlow2D() {
}

shared_ptr<Triangulation<2> > PeriodicTestFlow2D::makeGrid() {
...
shared_ptr<BoundaryCollection<2> > PeriodicTestFlow2D::makeBoundaries() {
