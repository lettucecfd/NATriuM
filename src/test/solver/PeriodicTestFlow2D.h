 ...
 */
class PeriodicTestFlow2D: public ProblemDescription<2> {
public:

	/// constructor
	PeriodicTestFlow2D(double relaxationParameter, const numeric_vector& velocity);

	/// destructor
	virtual ~PeriodicTestFlow2D();
