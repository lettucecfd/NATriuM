...
BOOST_AUTO_TEST_CASE(ExponentialTimeIntegrator_MPI_test) {
	pout << "ExponentialTimeIntegrator_MPI_test..." << endl;
	...
	AdvectionBenchmark::AdvectionResult advectionResult =
			AdvectionBenchmark::oneTest(N, p, delta_t, t_end,
					EXPONENTIAL, NONE, is_smooth, false, false);
	...
	pout << "done." << endl;
}/* ExponentialTimeIntegrator_MPI_test */
