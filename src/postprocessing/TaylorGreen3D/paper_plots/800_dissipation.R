require (tikzDevice)
library(tikzDevice)
tikz("800_dissipation.tex", standAlone=TRUE, height=3.2, width=4)
...
seq_13=seq(1,length(Re100_bgk$t),length(Re100_bgk$t)/13)
seq_15=seq(1,length(Re100_bgk$t),length(Re100_bgk$t)/15)
source("colors.R")

#plot (bootom left top right)
par( mai = c(0.7, 0.8, 0.2, 0.2) )

plot(1,type="n", xlim=c(-3,20), ylim=c(0,0.014), xlab="Time $t$", ylab="Dissipation")
#Re100
#points (Re100_bgk$t, Re100_bgk$dissipation, type="l", lw=2, col=BGKC1)
#points (Re100_bgk$t[seq_14], Re100_bgk$dissipation[seq_14], type="p", lw=2, pch=3, col=BGKC1)
#points (Re100_reg$t, Re100_reg$dissipation, type="l", lw=2, col=REGC1)
#points (Re100_reg$t[seq_12], Re100_reg$dissipation[seq_12], type="p", lw=2, pch=1, col=REGC1)
#points (Re100_ref$V1, Re100_ref$V2, type="l", lw=2, col="black")
#Re200
#points (Re200_bgk$t, Re200_bgk$dissipation, type="l", lw=2, col=BGKC1)
#points (Re200_bgk$t[seq_14], Re200_bgk$dissipation[seq_14], type="p", lw=2, pch=3, col=BGKC1)
#points (Re200_reg$t, Re200_reg$dissipation, type="l", lw=2, col=REGC1)
#points (Re200_reg$t[seq_12], Re200_reg$dissipation[seq_12], type="p", lw=2, pch=1, col=REGC1)
#points (Re200_ref$V1, Re200_ref$V2, type="l", lw=2, col="black")
#Re400
#points (Re400_bgk$t, Re400_bgk$dissipation, type="l", lw=2, col=BGKC1)
#points (Re400_bgk$t[seq_14], Re400_bgk$dissipation[seq_14], type="p", lw=2, pch=3, col=BGKC1)
#points (Re400_reg$t, Re400_reg$dissipation, type="l", lw=2, col=REGC1)
#points (Re400_reg$t[seq_12], Re400_reg$dissipation[seq_12], type="p", lw=2, pch=1, col=REGC1)
#points (Re400_ref$V1, Re400_ref$V2, type="l", lw=2, col="black")
#Re800
...
points (Re800_bgk$t, Re800_bgk$enstrophy/800, type="l", lw=2, col=BGKC2)
points (Re800_bgk$t[seq_13], Re800_bgk$enstrophy[seq_13]/800, type="p", lw=2, pch=BGKP2, col=BGKC2)
points (Re800_reg$t, Re800_reg$enstrophy/800, type="l", lw=2, col=REGC2)
points (Re800_reg$t[seq_15], Re800_reg$enstrophy[seq_15]/800, type="p", lw=2, pch=REGP2, col=REGC2)
points (Re800_ref$V1, Re800_ref$V2, type="l", lw=4, lty=2, col="black")
#Re1600
#points (Re1600_bgk$t, Re1600_bgk$dissipation, type="l", lw=2, col=BGKC1)
#points (Re1600_bgk$t[seq_14], Re1600_bgk$dissipation[seq_14], type="p", lw=2, pch=3, col=BGKC1)
#points (Re1600_reg$t, Re1600_reg$dissipation, type="l", lw=2, col=REGC1)
#points (Re1600_reg$t[seq_12], Re1600_reg$dissipation[seq_12], type="p", lw=2, pch=1, col=REGC1)
#points (Re1600_ref$V1, Re1600_ref$V2, type="l", lw=2, col="black")

legend("topleft", bty="n", legend=c("Stabilized $-dk/dt$","Stabilized $\\nu \\mathcal{E}$","BGK $-dk/dt$","BGK $\\nu \\mathcal{E}$","Reference"), col=c( REGC1,REGC2,BGKC1,BGKC2, "black"), lw=c(2,2,2,2,4), lty=c(1,1,1,1,2), pch=c(REGP1,REGP2,BGKP1,BGKP2,-1))
title("$Re=800$")
