require (tikzDevice)
library(tikzDevice)
tikz("200_dissipation.tex", standAlone=TRUE, height=3.2, width=4)
...
#preparation
seq_14=seq(1,length(Re200_bgk$t),length(Re200_bgk$t)/14)
seq_12=seq(1,length(Re200_bgk$t),length(Re200_bgk$t)/12)
seq_13=seq(1,length(Re200_bgk$t),length(Re200_bgk$t)/13)
seq_15=seq(1,length(Re200_bgk$t),length(Re200_bgk$t)/15)
...
points (Re200_bgk$t, Re200_bgk$enstrophy/200, type="l", lw=2, col=BGKC2)
points (Re200_bgk$t[seq_13], Re200_bgk$enstrophy[seq_13]/200, type="p", lw=2, pch=BGKP2, col=BGKC2)
points (Re200_reg$t, Re200_reg$enstrophy/200, type="l", lw=2, col=REGC2)
points (Re200_reg$t[seq_15], Re200_reg$enstrophy[seq_15]/200, type="p", lw=2, pch=REGP2, col=REGC2)
...
legend("topright", bty="n", legend=c("Stabilized $-dk/dt$","Stabilized $\\nu \\mathcal{E}$","BGK $-dk/dt$","BGK $\\nu \\mathcal{E}$","Reference"), col=c( REGC1,REGC2,BGKC1,BGKC2, "black"), lw=c(2,2,2,2,4), lty=c(1,1,1,1,1), pch=c(REGP1,REGP2,BGKP1,BGKP2,-1))
title("$Re=200$")
