...
SolverConfiguration::SolverConfiguration() {
	...
	enter_subsection("Collision");
	{
		declare_entry("Collision scheme", "BGK standard",
				dealii::Patterns::Selection(
						"BGK standard|BGK steady state|BGK standard transformed|BGK multiphase|BGK incompressible|BGK regularized|MRT standard|MRT entropic|KBC standard|KBC central|BGK multi am4|BGK multi bdf2"),
