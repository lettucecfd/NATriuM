/*
 * CompressibleErrorStats.h
 *
 *  Created on: 27.06.2014
 *      Author: kraemer
 */

#ifndef COMPRESSIBLEERRORSTATS_H_
#define COMPRESSIBLEERRORSTATS_H_

#include <fstream>

#include "PhysicalProperties.h"
//#include "BenchmarkCompressibleCFDSolver.h"-> must not be in there because CFDBenchmarkSolver includes this module
...
namespace natrium {
template<size_t dim> class BenchmarkCompressibleCFDSolver;

/**
 * @short Container for error statistics and table file; only for use with BenchmarkCompressibleCFDSolver
 * @note As this class is a friend of BenchmarkCompressibleCFDSolver, it can access its private attributes
 */
template<size_t dim>
class CompressibleErrorStats {
private:

	BenchmarkCompressibleCFDSolver<dim> * m_solver;
...
public:
	 ...
	 */
	CompressibleErrorStats(BenchmarkCompressibleCFDSolver<dim> * cfdsolver,
...
#endif /* COMPRESSIBLEERRORSTATS_H_*/
