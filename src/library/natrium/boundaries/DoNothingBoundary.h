...
/**
 * @short Outflow boundary which extrapolates the incoming distribution by the next inner one
 */
template<size_t dim>
...
public:
	...
	/**
	 * @short calculate boundary values. This function overrides the virtual function of Boundary<dim>. Nothing to do for this kind of BC.
