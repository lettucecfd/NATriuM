...
CommandLineParser::CommandLineParser(int argc, char** argv) :
	...
	setArgument<string>("stencil",
			"stencil that defines the discrete particle velocities [d2q9, d3q19, d3q15, d3q27, d2q19v, d2q19h, d2q777, d2q25h, d3q45, d3q77, d3v27]");
...
void CommandLineParser::applyToSolverConfiguration(SolverConfiguration& cfg) {
	...
	if (hasArgument("stencil")) {
		...
		if (sten == "d2q9") {
			...
			cfg.setStencil(Stencil_D2Q19H);
        } else if (sten == "d2q19v") {
            cfg.setStencil(Stencil_D2Q19V);
        } else if (sten == "d2q777") {
            cfg.setStencil(Stencil_D2Q777);
		} else if (sten == "d2q25h") {
		    cfg.setStencil(Stencil_D2Q25H);
        } else if (sten == "d3q45") {
            cfg.setStencil(Stencil_D3Q45);
		} else if (sten == "d3q77") {
            cfg.setStencil(Stencil_D3Q77);
        } else if (sten == "d3v27") {
            cfg.setStencil(Stencil_D3V27);
		} else {
			std::stringstream msg;
