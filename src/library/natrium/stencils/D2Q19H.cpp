...
D2Q19H::D2Q19H(double scaling) :
		Stencil(D, Q, makeDirections(scaling), makeWeights(), Stencil_D2Q19H,
...
vector<numeric_vector> D2Q19H::makeDirections(double scaling) {
	...
	for (size_t i = 0; i < Q; i++) {
		...
		direction(0) = scaling * directionsArray[i][1] / sqrt(3);
		direction(1) = scaling * directionsArray[i][0] / sqrt(3);
		result += direction;
	}
	return result;
} /// make directions
